...
uint8_t OLEDdata[255];
TWIbuffer OLEDbuf(OLEDdata,255);
...
void setTimePage(bool bNew) {		// Titlepage comments apply here, too.
	...
	switch(step) {
		...
		case 3:
			oled.setCursor(2,50);
			itoa(esc.ilocalHour, ch,10);		// Convert integer to ASCII
			oled.rJustify(ch,3);					// Right justify in 3-byte field.
			oled.writeChar(ch,DOUBLESIZE);
			oled.setRow(2);
			itoa(esc.ilocalMinute, ch,10);
...
void setLocationPage(bool bNew) {		// Titlepage comments apply here, too.
	...
	switch(step) {
		...
		case 3:
			oled.setCursor(2,5);
			itoa(esc.ilocalLatDegrees, ch,10);
			oled.rJustify(ch,4);
			oled.writeChar(ch,DOUBLESIZE);
			oled.setRow(2);
			itoa(esc.ilocalLatMinutes, ch,10);
		...
		case 5:
			oled.setCursor(2,58);
			itoa(esc.ilocalLongDegrees, ch,10);
			oled.rJustify(ch,5);
			oled.writeChar(ch,DOUBLESIZE);
			oled.setRow(2);
			itoa(esc.ilocalLongMinutes, ch,10);
			oled.rJustify(ch,3,'0');
			oled.writeChar(ch,DOUBLEWIDE);
...
void AltAzPage(bool bNew) {		// Titlepage comments apply here, too.
	...
	switch(step) {
		...
		case 5:
			oled.setCursor(2,5);
			itoa(esc.iAltDegrees, ch,10);		// Convert integer to ASCII
			oled.rJustify(ch,4);					// Right justify in 4-byte field.
			oled.writeChar(ch,DOUBLESIZE);
			oled.setRow(2);
			itoa(esc.iAltMinutes, ch,10);
		...
		case 7:
			oled.setCursor(2,68);
			itoa(esc.iAzDegrees, ch,10);
			oled.rJustify(ch,4);
			oled.writeChar(ch,DOUBLESIZE);
			oled.setRow(2);
			itoa(esc.iAzMinutes, ch,10);
			oled.rJustify(ch,3,'0');
			oled.writeChar(ch,DOUBLEWIDE);
...
void RADecPage(bool bNew) {		// Titlepage comments apply here, too.
	...
	switch(step) {
		...
		case 5:
			oled.setCursor(2,5);
			itoa(esc.iRAHours, ch,10);
			oled.rJustify(ch,4);
			oled.writeChar(ch,DOUBLESIZE);
			oled.setRow(2);
			itoa(esc.iRAMinutes, ch,10);
			oled.rJustify(ch,3,'0');
			oled.writeChar(ch,DOUBLEWIDE);
			oled.setCursor(3,40);
			oled.writeChar("RA");
		...
		case 7:
			oled.setCursor(2,68);
			itoa(esc.iDecDegrees, ch,10);
			oled.rJustify(ch,4);
			oled.writeChar(ch,DOUBLESIZE);
			oled.setRow(2);
			itoa(esc.iDecMinutes, ch,10);
			oled.rJustify(ch,3,'0');
			oled.writeChar(ch,DOUBLEWIDE);
			oled.setCursor(3,103);
			oled.writeChar("Dec");
